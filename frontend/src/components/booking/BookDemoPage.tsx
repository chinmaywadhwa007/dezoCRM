...
export const BookDemoPage: React.FC = () => {
  ...
  // Calendar State (Defaulting to August 2026 based on current context)
  const today = new Date(2026, 7, 3); // August 3, 2026
  const [currentCalendarDate, setCurrentCalendarDate] = useState<Date>(new Date(2026, 7, 1));
  const [selectedDate, setSelectedDate] = useState<Date>(new Date(2026, 7, 5)); // Default Aug 5, 2026
              ...
              {isSubmitted && (
                ...
                >
                  ...
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-300 dark:border-cyan-500/30 text-[11px] font-extrabold text-cyan-600 dark:text-cyan-400 mb-3">
                    <Database className="w-3.5 h-3.5" /> Scheduled & Saved to Local Storage
                  </span>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="md:col-span-5 space-y-4">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-4">
                      ...
                      >
                        <option>EST (UTC-5) - Eastern Time</option>
                        <option>PST (UTC-8) - Pacific Time</option>
                        <option>GMT (UTC+0) - London Time</option>
                        <option>IST (UTC+5:30) - India Time</option>
                        <option>JST (UTC+9) - Tokyo Time</option>
                      </select>
                    </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 via-cyan-50 to-indigo-50 dark:from-blue-950/40 dark:via-cyan-950/30 dark:to-indigo-950/40 border border-blue-200 dark:border-blue-500/30 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <button
                    type="button"
                    onClick={() => setCurrentStep(2)}
                    className="w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-bold text-xs shadow-md shadow-blue-600/25 transition cursor-pointer inline-flex items-center justify-center gap-2 border-none shrink-0"
                  >
