...
const API_DEMOS = 'http://localhost:5000/api/v1/demos?active=true';
...
export const MiddleGridSection: React.FC = React.memo(() => {
  ...
  useEffect(() => {
    const fetchDemos = async () => {
      try {
        const res = await fetch(API_DEMOS);
  ...
  return (
    <section
      ...
      className="py-20 bg-slate-950 dark:bg-slate-950 border-t border-white/10 dark:border-white/5 transition-colors duration-300 font-['Plus_Jakarta_Sans',sans-serif] relative overflow-hidden text-slate-100 group/section"
    >
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <motion.div
          ...
          className="mb-8 p-4 sm:p-5 rounded-3xl bg-slate-900/60 dark:bg-slate-950/70 border border-white/10 dark:border-white/5 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.06)] relative overflow-hidden group/banner"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch relative">
          ...
          <motion.div
            ...
            className="lg:col-span-3 bg-slate-900/60 dark:bg-slate-950/70 rounded-3xl border border-white/10 dark:border-white/5 p-5 text-left shadow-[0_20px_50px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-2xl flex flex-col justify-between relative overflow-hidden group/explorer"
          >
            <div>
              {/* Header Badge */}
                ...
                {[
                  ...
                  return (
                    <motion.div
                      ...
                      className={`p-3 rounded-2xl bg-slate-900/50 border border-white/10 dark:border-white/5 ${ind.border} hover:bg-gradient-to-b hover:from-white/10 hover:to-white/5 transition-all duration-300 cursor-pointer flex flex-col justify-between group/ind relative overflow-hidden backdrop-blur-md`}
                    >
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-white truncate group-hover/ind:text-blue-400 transition-colors">
                          {ind.name}
                        </h4>
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-slate-900/60 dark:bg-slate-950/70 rounded-3xl border border-white/10 dark:border-white/5 p-6 text-left shadow-[0_20px_50px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.06),0_0_40px_rgba(139,92,246,0.12)] backdrop-blur-2xl flex flex-col justify-between relative overflow-hidden transition-all duration-300 hover:border-purple-500/40 group/showcase z-10"
          >
            ...
            <div>
              ...
              <div className="mt-4 p-3.5 rounded-2xl bg-slate-950/50 border border-white/10 dark:border-white/5 flex items-center justify-between gap-3 backdrop-blur-md">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <span className="text-[10px] font-black text-slate-300 bg-white/5 border border-white/10 px-2.5 py-1 rounded-lg flex items-center gap-1">
                  ...
                  return (
                    <button
                      ...
                      className={`p-2.5 rounded-xl border text-left transition-all duration-300 cursor-pointer flex flex-col justify-between ${
                        isSelected
                          ? 'bg-gradient-to-br from-blue-600/90 to-purple-600/90 text-white border-blue-400/60 shadow-[0_0_20px_rgba(59,130,246,0.3)] backdrop-blur-md'
                          : 'bg-slate-950/40 border-white/10 text-slate-300 hover:bg-white/5 hover:border-white/20 backdrop-blur-md'
                      }`}
                    >
                      <div className="flex items-center justify-between w-full">
                        <span className={`text-[10px] font-black uppercase tracking-tight truncate ${isSelected ? 'text-white' : 'text-slate-200'}`}>
                          {demo.title.replace(' Demo', '').replace(' Suite', '')}
                        </span>
                        <Monitor className={`w-3 h-3 shrink-0 ${isSelected ? 'text-white' : 'text-slate-400'}`} />
                      </div>
                      <span className={`text-[9px] font-semibold block truncate mt-1 ${isSelected ? 'text-blue-100' : 'text-slate-400'}`}>
                        {demo.category || 'SaaS'}
                      </span>
                    </button>
                  );
            ...
            {/* Bottom CTA Buttons */}
            <div className="pt-4 mt-4 border-t border-white/10 dark:border-white/5 flex items-center gap-3">
              <motion.button
                type="button"
              ...
              <motion.button
                ...
                className="py-3 px-4 rounded-xl bg-slate-950/60 hover:bg-slate-900 text-slate-200 font-extrabold text-xs transition-all duration-300 cursor-pointer border border-white/10 hover:border-white/20 backdrop-blur-md flex items-center gap-1.5 shrink-0"
              >
          ...
          <motion.div
            ...
            className="lg:col-span-4 bg-slate-900/60 dark:bg-slate-950/70 rounded-3xl border border-white/10 dark:border-white/5 p-6 text-left shadow-[0_20px_50px_rgba(0,0,0,0.4),0_0_0_1px_rgba(255,255,255,0.06)] backdrop-blur-2xl flex flex-col justify-between relative overflow-hidden group/form"
          >
            <div>
              {/* Header Badge */}
              <div className="flex items-center justify-between mb-3.5">
              ...
              <div className="grid grid-cols-2 gap-2 p-3 mb-4 rounded-2xl bg-slate-950/50 border border-white/10 text-[10px] font-extrabold text-slate-300 backdrop-blur-md">
              ...
              <AnimatePresence mode="wait">
                {formSubmitted ? (
                  ...
                  >
                    <div>
                      <label className="block text-[11px] font-extrabold text-slate-300 mb-1.5 tracking-wide">
                        Full Name *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950/50 border border-white/10 text-xs font-semibold text-white placeholder:text-slate-500 shadow-[inset_0_1px_2px_rgba(0,0,0,0.5)] focus:outline-none focus:border-blue-500 focus:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-300"
                      />
                    </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950/50 border border-white/10 text-xs font-semibold text-white shadow-[inset_0_1px_2px_rgba(0,0,0,0.5)] focus:outline-none focus:border-blue-500 focus:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-300 cursor-pointer appearance-none pr-8"
                          >
                            <option value="Hospital ERP Suite" className="bg-slate-900 text-white">Hospital ERP Suite</option>
                            <option value="SchoolyCore ERP" className="bg-slate-900 text-white">SchoolyCore ERP</option>
                            <option value="CRM AI Copilot" className="bg-slate-900 text-white">CRM AI Copilot</option>
                            <option value="HRMS Suite" className="bg-slate-900 text-white">HRMS Suite</option>
                            <option value="Custom Enterprise SaaS" className="bg-slate-900 text-white">Custom Enterprise SaaS</option>
                          </select>
