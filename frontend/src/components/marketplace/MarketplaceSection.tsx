                ...
                {card.isMore ? (
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <motion.button
                      ...
                      transition={{ duration: 0.4, delay: 0.45 + index * 0.08 }}
                      onClick={() => navigateTo('/products')}
                      className="py-2 px-2.5 rounded-lg border border-blue-600 text-blue-600 dark:text-blue-400 font-bold text-[11px] hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 dark:hover:text-white transition-all duration-300 shadow-sm cursor-pointer"
                    >
                      View Details
                    </motion.button>
                    ...
                    <motion.button
                      ...
                      className="py-2 px-2.5 rounded-lg border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-[11px] hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 cursor-pointer"
                    >
                      Watch Demo
                    </motion.button>
                  </div>
