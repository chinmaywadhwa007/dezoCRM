            ...
            <motion.div variants={itemFadeUp} className="max-w-xl">
              <form onSubmit={handleSearchSubmit} className="relative group">
                <motion.div
                  ...
                  className={`relative flex items-center bg-white dark:bg-slate-900/90 border rounded-2xl p-2 transition-all duration-300 shadow-lg ${isFocused
                      ? 'border-blue-600 dark:border-cyan-400 ring-4 ring-blue-500/20 dark:ring-cyan-400/20 shadow-blue-500/15'
                      : 'border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700'
                    }`}
                >
                  <Search className={`w-5 h-5 ml-3 transition-colors duration-200 ${isFocused ? 'text-blue-600 dark:text-cyan-400' : 'text-slate-400'}`} />
                  ...
                  <input
                    ...
                    placeholder="Search software catalog (e.g. SchoolyCore, HMS, AI Copilot)..."
