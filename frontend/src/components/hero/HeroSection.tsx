...
export const HeroSection: React.FC = React.memo(() => {
  ...
  return (
    <section
      ...
      className="relative pt-6 pb-16 lg:pt-12 lg:pb-24 overflow-hidden min-h-[700px] flex items-center justify-center bg-gradient-to-b from-blue-50/60 via-slate-50/40 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-colors duration-500 font-sans"
    >
