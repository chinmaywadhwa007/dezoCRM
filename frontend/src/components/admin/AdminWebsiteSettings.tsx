...
import {
  ...
  Image, Shield, Eye, EyeOff, X, Wifi, WifiOff, FolderOpen,
  ...
  return (
    <div className="space-y-6 font-['Plus_Jakarta_Sans',sans-serif]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 shadow-sm space-y-5">
                  ...
                  <button type="button" onClick={() => setMediaPicker({ open: true, field: 'logoUrl' })}
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/30 text-purple-600 dark:text-purple-400 text-xs font-extrabold transition cursor-pointer">
                  ...
                  <div className="rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
                    ...
                    <div className="p-8 bg-white flex items-center justify-center min-h-[100px]">
                      {settings.logoUrl
                        ? <img src={resolveUrl(settings.logoUrl)} alt="Logo" className="max-h-16 max-w-[240px] object-contain" onError={e => (e.currentTarget.style.display = 'none')} />
                        : <div className="flex flex-col items-center gap-2 text-slate-300"><Image className="w-10 h-10" /><span className="text-[10px] font-semibold">No logo uploaded</span></div>
                      }
                    </div>
                    <div className="px-3 py-1.5 bg-slate-800 text-[10px] font-bold text-slate-400">DARK MODE PREVIEW</div>
                    <div className="p-8 bg-slate-900 flex items-center justify-center min-h-[100px]">
                      {settings.logoUrl
                        ? <img src={resolveUrl(settings.logoUrl)} alt="Logo dark" className="max-h-16 max-w-[240px] object-contain" onError={e => (e.currentTarget.style.display = 'none')} />
                        : <div className="flex flex-col items-center gap-2 text-slate-600"><Image className="w-10 h-10" /><span className="text-[10px] font-semibold">No logo uploaded</span></div>
                      }
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 shadow-sm space-y-5">
                  ...
                  <button type="button" onClick={() => setMediaPicker({ open: true, field: 'faviconUrl' })}
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-600 dark:text-amber-400 text-xs font-extrabold transition cursor-pointer">
                    <FolderOpen className="w-4 h-4" />
                    Pick from Media Library
                  </button>
      ...
      <MediaPickerModal
        ...
        allowedTypes={['image']}
        onSelect={(url) => { set(mediaPicker.field, url); setMediaPicker(p => ({ ...p, open: false })); }}
      />
    </div>
  );
};
