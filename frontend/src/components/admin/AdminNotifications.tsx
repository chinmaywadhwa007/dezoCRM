...
const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  {
    id: 'n-1',
    type: 'security',
    title: 'New Super Admin Session',
    message: 'Super Admin logged in from IP 192.168.1.45 (Chrome, Windows)',
    time: '2 mins ago',
    isRead: false,
  },
  {
    id: 'n-2',
    type: 'user',
    title: 'New Editor Account Created',
    message: 'Sarah Jenkins (Editor) account was created by Admin.',
    time: '15 mins ago',
    isRead: false,
  },
  {
