    ...
    <>
      ...
      >
        ...
        <div className={`p-4 border-b flex items-center justify-between transition-all ${
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-400 via-blue-600 to-purple-600 p-[2px] shadow-lg shadow-cyan-500/20 group-hover:scale-105 transition-transform shrink-0">
